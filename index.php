  ...
  <main>
    <article>
      ...
      <section class="section hero has-bg-image" aria-label="home"
        style="background-image: url('https://media.istockphoto.com/id/1308682666/vector/blue-gradient-soft-background.jpg?s=612x612&w=0&k=20&c=CBSD2BDe2uMi-Zm65ny6KoPKXsTPdk5K8wt_vMIb3Hc=')">
        <div class="container">

          <div class="hero-content">

            <h1 class="h1 hero-title">Advance HealthCare made pesonal</h1>
            ...
            <div class="btn-wrapper">
              ...
              <a href="<?php echo get_template_directory_uri(); ?>./ContactUs.php" class="btn btn-outline">Contact Us</a>
              ...
              <ul class="slider-container" data-slider-container>
                ...
                <li class="slider-item">
                  ...
                  <figure class="img-holder" style="--width: 575; --height: 550;">
                    <img src="https://www.diginerve.com/wp-content/uploads/2023/01/Career-as-a-Gynecologist-How-to-Become-Courses-Skills-Career-Scope-_-Salary.webp" width="575" height="550" alt="" class="img-cover">
                  </figure>
                ...
                <li class="slider-item">
                  ...
                  <div class="hero-card">
                    <figure class="img-holder" style="--width: 575; --height: 550;">
                      <img src="https://www.opaortho.com/wp-content/uploads/2021/12/Doctor-shows-the-spine-conditions.jpg" width="575" height="550" alt="hero banner"
                        class="img-cover">
                    </figure>
                ...
                <li class="slider-item">
                  ...
                  <figure class="img-holder" style="--width: 575; --height: 550;">
                    <img src="https://modernheartandvascular.com/wp-content/uploads/2022/10/shutterstock_656744362.jpg" width="575" height="550" alt="" class="img-cover">
                  </figure>
      ...
      <section class="about" aria-labelledby="about-label">
        <div class="container">
          ...
          <figure class="about-banner">
            <img src="<?php echo get_template_directory_uri() ?>./assets/images/about-banner.png" width="800" height="580" loading="lazy" alt="about banner"
              class="w-100">
          </figure>
      ...
      <section class="section feature" aria-labelledby="feature-label">
        <div class="container">
          ...
          <figure class="feature-banner">
            <img src="<?php echo get_template_directory_uri()  ?>./assets/images/feature-banner.png" width="800" height="531" loading="lazy" alt="feature banner"
              class="w-100">
          </figure>
      ...
      <section class="stats" aria-label="our stats">
        <div class="container">
          ...
          <ul class="stats-card has-bg-image" style="background-image: url('<?php echo get_template_directory_uri() ?>./assets/images/stats-bg.jpg')">
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="project-card">
                ...
                <figure class="card-banner img-holder" style="--width: 560; --height: 350;">
                  <img src="<?php echo get_template_directory_uri()  ?>./assets/images/blog-1.jpg" width="560" height="350" loading="lazy"
            ...
            <li>
              <div class="project-card">
                ...
                <figure class="card-banner img-holder" style="--width: 560; --height: 350;">
                  <img src="<?php echo get_template_directory_uri()  ?>./assets/images/blog-2.jpg" width="560" height="350" loading="lazy"
            ...
            <li>
              <div class="project-card">
                ...
                <figure class="card-banner img-holder" style="--width: 560; --height: 350;">
                  <img src="<?php echo get_template_directory_uri()  ?>./assets/images/blog-3.jpg" width="560" height="350" loading="lazy"
